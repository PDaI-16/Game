...
public void LoadNextLevel()
{
    ...
    EnemySpawner.SpawnBossEnemyToRandomLocation(currentLevel);
    EnemySpawner.SpawnMeleeEnemyToRandomLocation(currentLevel);
    EnemySpawner.SpawnRangedEnemyToRandomLocation(currentLevel);

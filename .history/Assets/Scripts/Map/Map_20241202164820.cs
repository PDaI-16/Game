...
public class Map : MonoBehaviour
{
    ...
    public bool randomizeSeeds = false; // Add this field for the checkbox
    ...
    void Start()
    {
        if (!randomizeSeeds)
        {
            ...
            {
                new Wave { seed = 56, frequency = 0.08f, amplitude = 1.0f },
                new Wave { seed = 199, frequency = 0.15f, amplitude = 0.75f }
            };

            moistureWaves = new Wave[]
            {
                new Wave { seed = 621, frequency = 0.03f, amplitude = 0.8f }
            };

            heatWaves = new Wave[]
            {
                new Wave { seed = 318, frequency = 0.02f, amplitude = 0.8f },
                new Wave { seed = 329, frequency = 0.02f, amplitude = 0.5f }
            };
        }
        GenerateMap();
...
void GenerateMap()
{
    if (randomizeSeeds)
    {
        ...
        {
            wave.seed = Random.Range(0, int.MaxValue);
        }
